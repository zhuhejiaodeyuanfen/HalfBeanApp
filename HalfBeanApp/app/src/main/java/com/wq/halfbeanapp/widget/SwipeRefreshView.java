package com.wq.halfbeanapp.widget;
...
public class SwipeRefreshView extends SwipeRefreshLayout implements
...
//    }
    ...
    private boolean canLoad() {
        return isBottom() && !isLoading && isPullUp() && isCanPullLoad();
    }

    private boolean canPullLoad = false;
...
//                progressBar.setProgressDrawable(getResources().getDrawable(R.drawable.progressbar_circle));
                mListView.addFooterView(mListViewFooter);
            }
        } else {
            if (mListViewFooter != null && mListView != null) {
                ...
                ProgressBar progressBar = (ProgressBar) mListViewFooter.findViewById(R.id.pull_to_refresh_load_progress);
//                progressBar.setIndeterminateDrawable(getResources().getDrawable(R.drawable.load));
//                progressBar.setProgressDrawable(getResources().getDrawable(R.drawable.load));
