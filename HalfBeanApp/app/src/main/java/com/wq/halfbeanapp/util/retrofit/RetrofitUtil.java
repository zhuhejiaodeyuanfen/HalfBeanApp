...
public class RetrofitUtil {
     ...
     * @param subscriber
     */
    public void getUsers(int page, int rows, Subscriber<BaseResponse<List<MsgModel>>> subscriber) {
//        mApiService.getMsgList()
//                .subscribeOn(Schedulers.io())
//                .unsubscribeOn(Schedulers.io())
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(subscriber);
//
        toSubscribe(mApiService.getMsgList(page, rows), subscriber);
    }
